...
, function(e, t, a) {
    !function() {
        this.__angular_wrapper_loaded__ || (this.__angular_wrapper_loaded__ = !0,
        a(3)),
        e.exports = angular
    }()
}
...
, function(e, t, a) {
    !function() {
        ...
        a(33),
        a(52),
        e.exports = t.module("calc", ["calc.services", "calc.routes", "calc.filters", "calc.controllers", "calc-templates"])
    }()
}
, function(e, t, a) {
    !function() {
        ...
        var e = a(10)
          , t = function(e, t) {
              ...
              e.getHelpGA = function() {
                  var e = a ? "hide" : "show";
                  t.logEvent("getHelp", e, "/calculate-stamp-duty-land-tax/" + document.location.href.split("/").pop()),
                  a = !a
              }
              ,
              ...
              e.removeFocusFromLabel = function() {
                  ...
                  $(this).is(":checked") || $(this).closest("label").removeClass("selected")
              }
              ,
              e.toggleFocus = function() {
                  "radio" === $(this).attr("type") && $(this).closest("label").siblings().removeClass("add-focus selected"),
    ...
    !function() {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o, l) {
              var d = a(12);
              d(e, t, r, "additional-property", n, i, o),
...
, function(e, t) {
    !function() {
        ...
        e.exports = function(e, t, a, r, n, i, o) {
            ...
            $("#pageErrors").hide(),
            e.submit = function() {
                e.state = i.validate(e.data),
                e.state.isValid ? (angular.isDefined(e.beforeUpdateModel) && e.beforeUpdateModel(),
                n.updateModel(e.data),
                o.next(r, e.data, t)) : $("#pageErrors").show().focus()
            }
        }
    }()
}
, function(e, t, a) {
    !function() {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o, l) {
              var d = a(12);
              d(e, t, r, "exchange-contracts", n, i, o),
              e.beforeUpdateModel = function() {
...
, function(e, t) {
    !function() {
        ...
        function t(e, t, a, r) {
            ...
            return n = isNaN(e),
            i = "Invalid Date" == e,
            n || i ? !1 : o.test(t) ? e.getFullYear() === parseInt(t) && e.getMonth() === parseInt(a) - 1 && e.getDate() === parseInt(r) : !1
        }
        var a = function(e, a, r) {
            ...
            r = r || "empty",
            n = e + a + r,
            "emptyemptyempty" === n ? "" : (i = new Date(e,a - 1,r),
            t(i, e, a, r) ? i : "bad date")
        }
          , r = function(e, t, a) {
              function r(e, t) {
...
, function(e, t, a) {
    !function() {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o) {
              function l(t) {
                  t.displayYearOneRent || (e.data.year1Rent = void 0),
                  t.displayYearTwoRent || (e.data.year2Rent = void 0),
                  t.displayYearThreeRent || (e.data.year3Rent = void 0),
                  t.displayYearFourRent || (e.data.year4Rent = void 0),
                  t.displayYearFiveRent || (e.data.year5Rent = void 0)
              }
              var d = a(12);
    ...
    !function() {
        ...
        e.exports = function() {
            var e = function(e) {
              ...
              , a = function(e) {
                  var a = t(e.data);
                  e.displayYearOneRent = a.displayYearOneRent,
                  e.displayYearTwoRent = a.displayYearTwoRent,
                  e.displayYearThreeRent = a.displayYearThreeRent,
                  e.displayYearFourRent = a.displayYearFourRent,
                  e.displayYearFiveRent = a.displayYearFiveRent
              }
            ;
            return {
                getFunctions: t,
...
, function(e, t, a) {
    !function() {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o) {
              var l = a(12);
              l(e, t, r, "premium", n, i, o),
              "Residential" === e.data.propertyType ? e.showPremiumHelp = !0 : "Non-residential" === e.data.propertyType && e.data.effectiveDate >= new Date(2016,2,17) ? e.showPremiumHelp = !0 : e.showPremiumHelp = !1
          }
        ;
    ...
    !function() {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o) {
              ...
              var d = a(20);
              d = d(),
              d.addFunctionsToScope(e),
              e.displayYearOneRent || t.path("summary")
          }
        ;
    ...
    !function() {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o, l) {
              var d = a(18);
              d(e, t, r, "result", n, o),
              e.viewDetails = function(a, r) {
                  e.data.resultIndex = a,
                  e.data.taxCalcIndex = r,
                  n.updateModel(e.data),
                  o.viewDetails(e.data, t)
              }
              ,
              ...
              var s = a(28)()
                ...
                , u = !1
                , p = a(20);
              if (p = p().getFunctions(e.data),
              i.validate(e.data).isModelValid) {
                  var f = {};
                  if ("Freehold" === e.data.holdingType)
                      ...
                      if (e.data.npv = h,
                      "Residential" === e.data.propertyType)
                          f = e.effDateOnOrAfter(new Date("April 1, 2016")) && "Yes" === e.data.individual && e.isAdditionalProperty() ? l.calcLeaseResPremAndRentAddProp_201604_Undef(e.data.premium, e.data.npv, !0) : e.effDateOnOrAfter(new Date("April 1, 2016")) && "No" === e.data.individual ? l.calcLeaseResPremAndRentAddProp_201604_Undef(e.data.premium, e.data.npv, !1) : e.effDateOnOrAfter(new Date("December 4, 2014")) ? l.calcLeaseResPremAndRent_201412_Undef(e.data.premium, e.data.npv) : l.calcLeaseResPremAndRent_201203_201412(e.data.premium, e.data.npv);
                      else {
                          var m = !1;
                          e.data.premium < 15e4 && c && e.data.relevantRent < 1e3 && (m = !0),
                          e.effDateOnOrAfter(new Date("March 17, 2016")) ? ((e.data.premium >= 15e4 || !c || c && "Yes" === e.data.contractPre201603 && "No" === e.data.contractVariedPost201603) && (u = !0),
                          f = l.calcLeaseNonResPremAndRent_201603_Undef(e.data.premium, e.data.npv, m, u)) : f = l.calcLeaseNonResPremAndRent_201203_201603(e.data.premium, e.data.npv, m)
                      }
                  }
                  e.data.result = f,
                  n.updateModel(e.data)
    ...
    !function() {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o, l) {
              ...
              var s = a(20);
              s = s(),
              s.addFunctionsToScope(e);
              var c = parseFloat("0");
              e.displayYearOneRent && c < parseFloat(e.data.year1Rent) && (c = e.data.year1Rent),
              e.displayYearTwoRent && c < parseFloat(e.data.year2Rent) && (c = e.data.year2Rent),
              e.displayYearThreeRent && c < parseFloat(e.data.year3Rent) && (c = e.data.year3Rent),
              e.displayYearFourRent && c < parseFloat(e.data.year4Rent) && (c = e.data.year4Rent),
              e.displayYearFiveRent && c < parseFloat(e.data.year5Rent) && (c = e.data.year5Rent),
              e.data.highestRent = c,
              e.validatedModel = i.validate(e.data);
              var u = a(30);
              e.data.summary = u.summaryHelper(e, e.validatedModel),
              n.updateModel(e.data),
              e.submit = function() {
        ...
        var t = a(28)
          ...
          , v = function(e, t) {
              for (var a = [{
                  ...
                  void 0 !== a[v].question && r.push(a[v]);
              return r
          }
        ;
        e.exports = {
        ...
        var e = a(10)
          , t = function(e, t, r, n, i, o) {
              var l = a(28)()
                , d = a(18);
              d(e, t, r, "detail", n, o),
              i.validate(e.data).isModelValid || t.path("summary"),
              e.printView = function() {
                  o.printView(e.data, t)
              }
              ,
...
, function(e, t, a) {
    !function() {
        ...
        e.service("calculationService", function() {
            ...
            function t(e, t, a, r) {
                for (var n = 0, i = 1.035, o = 1, l = 0, d = 0, s = 0; 4 >= s; s++)
                    o *= i,
                    n += Math.floor(1e3 * r[s] / o) / 1e3,
                    r[s] > l && (l = r[s]);
                if (e > 5)
                    for (var c = 6; e >= c; c++)
                        o *= i,
                        n += Math.floor(1e3 * l / o) / 1e3;
                return e >= 5 && t > 0 && (o *= i,
                d = l * t / a,
                n += Math.floor(d / o)),
                Math.floor(n)
            ...
            var a = "1 April 2016"
              ...
              , A = function(e, t) {
                  ...
                  var d = [o]
                    , s = {};
                  return s.resultHeading = v,
                  t && o.taxDue > r.taxCalcs[0].taxDue && (s.resultHint = l + (o.taxDue - r.taxCalcs[0].taxDue).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "."),
                  s.totalTax = i.taxDue,
                  s.taxCalcs = d,
                  [s, r]
              }
              ...
              , I = function(e, t) {
                  ...
                  var d = [n, l]
                    , s = {};
                  return s.totalTax = n.taxDue + l.taxDue,
                  s.npv = t,
                  s.taxCalcs = d,
                  [s]
              }
              ...
              , q = function(e, t, a) {
                  ...
                  n.resultHeading = f,
                  n.resultHint = h,
                  n.taxCalcs[0].detailHeading = b,
                  n.taxCalcs[1].detailHeading = Y;
                  var i = [{
                      from: 0,
                      to: 125e3,
                      rate: 0,
                  ...
                  var p = [d, u]
                    , m = {};
                  return m.resultHeading = v,
                  a && u.taxDue > n.taxCalcs[1].taxDue && (m.resultHint = l + (u.taxDue - n.taxCalcs[1].taxDue).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "."),
                  m.totalTax = d.taxDue + u.taxDue,
                  m.npv = t,
                  m.taxCalcs = p,
                  [m, n]
              }
              , B = function(e, t, a) {
                  ...
                  var s = [i, l]
                    , c = {};
                  return c.totalTax = i.taxDue + l.taxDue,
                  c.npv = t,
                  c.taxCalcs = s,
                  [c]
              }
              , G = function(e, t, a, r) {
                  ...
                  var c = [o, s]
                    , f = {};
                  if (f.resultHeading = p,
                  f.totalTax = o.taxDue + s.taxDue,
                  f.npv = t,
                  f.taxCalcs = c,
                  r) {
                      var v = B(e, t, a)
                        , h = v[0];
                      return h.resultHeading = u,
                      h.resultHint = m,
                      h.taxCalcs[0].detailHeading = P,
                      [f, h]
                  }
                  return [f]
              }
              ...
              , z = function(t, a) {
                  for (var r = -1, n = -1, i = 0, o = 0; o < a.length; o++)
                      -1 == a[o].to ? t > a[o].from ? (r = t - a[o].from,
                      n = e(r, a[o].rate),
                      a[o].taxDue = n,
                      i += n) : a[o].taxDue = 0 : t > a[o].to ? (r = a[o].to - a[o].from,
                      n = e(r, a[o].rate),
                      a[o].taxDue = n,
                      i += n) : t <= a[o].from ? a[o].taxDue = 0 : (r = t - a[o].from,
                      n = e(r, a[o].rate),
                      a[o].taxDue = n,
                      i += n);
                  var l = {
    ...
    !function() {
        ...
        var e = a(35)
          , t = function() {
              ...
              var t = a(28)()
                , r = function(e) {
                    return ga("set", "page", "/calculate-stamp-duty-land-tax/" + e),
                    ga("send", "pageview", {
                        anonymizeIp: !0
                    }),
                    e
                ...
                , s = function(r, n, i) {
                    if ("holding" === r)
                        ...
                        if ("Residential" === n.propertyType) {
                            ...
                            e(n, i);
                    else if ("purchase-price" === r)
                        o(i, "summary");
                    else if ("purchaser" === r)
                        "Yes" === n.individual ? o(i, "additional-property") : e(n, i);
                    else if ("additional-property" === r)
                        e(n, i);
                    else if ("lease-dates" === r)
                        o(i, "premium");
                    else if ("premium" === r)
                        o(i, "rent");
                    else if ("rent" === r) {
                        ...
                        "exchange-contracts" === r ? "Yes" === n.contractPre201603 && "No" === n.contractVariedPost201603 ? o(i, "relevant-rent") : o(i, "summary") : "relevant-rent" === r ? o(i, "summary") : o(i, "result")
                }
              ;
              return {
                  logView: r,
        ...
        e.service("additionalPropertyValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.twoOrMoreProperties) && (t.twoOrMoreProperties = "Provide an answer to continue. Select 'Yes' or 'No'"),
                "Yes" === e.twoOrMoreProperties && n.isNotPopulated(e.replaceMainResidence) && (t.replaceMainResidence = "Provide an answer to continue. Select 'Yes' or 'No'"),
                r(t)
            }
            ;
            return {
        ...
        e.service("exchangeContractsValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.contractPre201603) && (t.contractPre201603 = "Provide an answer to continue. Select 'Yes' or 'No'"),
                "Yes" === e.contractPre201603 && n.isNotPopulated(e.contractVariedPost201603) && (t.contractVariedPost201603 = "Provide an answer to continue. Select 'Yes' or 'No'"),
                r(t)
            }
            ;
            return {
        ...
        e.service("holdingValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.holdingType) && (t.holdingType = "Provide an answer to continue. Select 'Freehold' or 'Leasehold'"),
                r(t)
            }
            ;
            return {
        ...
        e.service("leaseDatesValidationService", function() {
            var e = function(e) {
                var t = {}
                  ...
                  , n = a(40)
                  , i = a(28)();
                return i.isNotPopulated(e.startDate) ? t.startDate = "Enter a start date" : i.isInvalidParsedDate(e.startDate) ? t.startDate = "Enter a valid date" : r = !0,
                i.isNotPopulated(e.endDate) ? t.endDate = "Enter an end date" : i.isInvalidParsedDate(e.endDate) ? t.endDate = "Enter a valid date" : r && i.isLessThanDate(e.endDate, e.startDate) ? t.endDate = "End date can't be before the start date" : e.effectiveDate && i.isLessThanDate(e.endDate, e.effectiveDate) && (t.endDate = "End date can't be before the effective date"),
                n(t)
            }
            ;
            return {
        ...
        e.service("premiumValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.premium) ? t.premium = "You must complete this box. Enter your Premium" : n.isInvalidFloat(e.premium) && (t.premium = "Enter the premium again - don't use any letters or characters including £"),
                r(t)
            }
            ;
            return {
        ...
        e.service("propertyValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.propertyType) && (t.propertyType = "Provide an answer to continue. Select 'Residential' or 'Non-residential'"),
                r(t)
            }
            ;
            return {
        ...
        e.service("purchasePriceValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.premium) ? t.premium = "You must complete this box. Enter your Purchase Price" : n.isInvalidFloat(e.premium) && (t.premium = "Enter the purchase price again - don't use any letters or characters including £"),
                r(t)
            }
            ;
            return {
        ...
        e.service("purchaserValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.individual) && (t.individual = "Provide an answer to continue. Select 'Yes' or 'No'"),
                r(t)
            }
            ;
            return {
        ...
        e.service("relevantRentValidationService", function() {
            var e = function(e) {
                var t = {}
                  , r = a(40)
                  , n = a(28)();
                return n.isNotPopulated(e.relevantRent) ? t.relevantRent = "Please enter the rental figure" : n.isInvalidFloat(e.relevantRent) && (t.relevantRent = "Enter the relevant rent again - don't use any letters or characters including £"),
                r(t)
            }
            ;
            return {
    ...
    !function() {
        ...
        e.service("rentValidationService", function() {
            var e = function(e) {
                ...
                ;
                return i.displayYearOneRent && o(e, t, "year1Rent"),
                i.displayYearTwoRent && o(e, t, "year2Rent"),
                i.displayYearThreeRent && o(e, t, "year3Rent"),
                i.displayYearFourRent && o(e, t, "year4Rent"),
                i.displayYearFiveRent && o(e, t, "year5Rent"),
                r(t)
            }
            ;
            return {
        ...
        e.service("modelValidationService", function() {
            var e = function(e) {
                ...
                "Leasehold" === e.holdingType) {
                    ...
                    "Non-residential" === e.propertyType && e.premium < 15e4 && o && (e.effectiveDate > new Date("March 16, 2016") ? (n.isContractPre201603Valid = i("contractPre201603"),
                    "Yes" === e.contractPre201603 && (n.isContractVariedPost201603Valid = i("contractVariedPost201603")),
                    "Yes" === e.contractPre201603 && "No" === e.contractVariedPost201603 && (n.isRelevantRentValid = i("relevantRent"))) : n.isRelevantRentValid = i("relevantRent"))
                }
                return n
            }
            ;
...
, function(e, t, a) {
    !function() {
        ...
        e.filter("calcCurrency", ["$filter", function(e) {
            return function(e, t) {
                return void 0 === e || "undefined" === e || "" === e ? "-" : (e = parseFloat(e),
                e = e % 1 === 0 ? e.toFixed(0) : e.toFixed(2),
                void 0 !== t && "undefined" !== t && "" !== t || (t = ""),
                t + e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","))
            }
        }
        ])
    }()
